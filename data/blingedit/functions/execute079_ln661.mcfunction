...
execute as @e[type=minecraft:magma_cube,tag=Corner] if score @s player = Global player if score @s type matches 1 run function blingedit:execute075_ln672
...
scoreboard players set @s moving_mode 0
function blingedit:clone_text_before