...
scoreboard players operation Global step_dx *= c2 Constant
scoreboard players operation Global step_dy *= c2 Constant
scoreboard players operation Global step_dz *= c2 Constant
...
# Fix for the sub-axis flip
execute unless score Global rotation matches 0..0 unless score Global rotation matches 180..180 if score Global flip_x matches 1.. unless score Global flip_z matches 1.. run scoreboard players add Global rotation 180
execute unless score Global rotation matches 0..0 unless score Global rotation matches 180..180 if score Global flip_z matches 1.. unless score Global flip_x matches 1.. run scoreboard players add Global rotation 180
scoreboard players operation Global rotation %= c360 Constant

execute if score Global rotation matches 0 run function blingedit:execute106_ln877
execute if score Global rotation matches 90 run function blingedit:execute107_ln884
execute if score Global rotation matches 180 run function blingedit:execute108_ln891
execute if score Global rotation matches 270 run function blingedit:execute109_ln898
...
execute if score @s moving_mode matches 1 run function blingedit:execute127_ln976
