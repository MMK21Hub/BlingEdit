...
execute if score @s state matches 12 as @e[type=minecraft:magma_cube,tag=Corner] if score @s player = @e[type=minecraft:player,limit=1,scores={mai_scratch0=1..}] _id run function blingedit:execute200_ln1627