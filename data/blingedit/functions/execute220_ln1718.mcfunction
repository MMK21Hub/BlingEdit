...
scoreboard players set @s window 1
scoreboard players add @e _age 1
summon minecraft:magma_cube ~ ~ ~ {ActiveEffects: [{Id: 14b, Duration: 2147483647, ShowParticles: 0b}],CustomName:"\"Corner\"", Tags:["Corner"], Glowing:1b, NoGravity:1b, NoAI:1b, Invulnerable:1b, Size:1b, Silent:1b, AbsorptionAmount:100f}
scoreboard players add @e _age 1
