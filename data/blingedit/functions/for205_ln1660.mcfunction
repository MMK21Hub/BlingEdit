...
execute if score Global z <= Global mai_scratch3 run function blingedit:for206_ln1663

scoreboard players operation Global x += Global mai_scratch2
execute if score Global x <= Global mai_scratch1 run function blingedit:for205_ln1660