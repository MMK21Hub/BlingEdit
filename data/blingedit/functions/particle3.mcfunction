...
scoreboard players set Global dra_scratch1 200
execute if score Global dra_scratch1 matches ..-1 if score Global z >= Global dra_scratch0 run function blingedit:particles/particle3_2
execute if score Global dra_scratch1 matches 1.. if score Global z <= Global dra_scratch0 run function blingedit:particles/particle3_2
scoreboard players operation Global y = Global p_ymin
scoreboard players operation Global dra_scratch0 = Global p_ymax
scoreboard players set Global dra_scratch1 200
execute if score Global dra_scratch1 matches ..-1 if score Global y >= Global dra_scratch0 run function blingedit:particles/particle3_3
execute if score Global dra_scratch1 matches 1.. if score Global y <= Global dra_scratch0 run function blingedit:particles/particle3_3
kill @s