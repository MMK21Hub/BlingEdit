execute at @s run function blingedit:patch_kipcode66_multi_block_clone/save_region
...
#execute at @s run function blingedit:clone_struct1
execute at @s run function blingedit:patch_kipcode66_multi_block_clone/execute5
execute at @s run function blingedit:patch_kipcode66_multi_block_clone/load_region