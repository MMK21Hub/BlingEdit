...
execute if score Global dra_scratch1 matches ..-1 if score Global x >= Global dra_scratch0 run function blingedit:particles/particle6_1
execute if score Global dra_scratch1 matches 1.. if score Global x <= Global dra_scratch0 run function blingedit:particles/particle6_1
scoreboard players operation Global z = Global p_zmin
scoreboard players operation Global dra_scratch0 = Global p_zmax
scoreboard players set Global dra_scratch1 200
execute if score Global dra_scratch1 matches ..-1 if score Global z >= Global dra_scratch0 run function blingedit:particles/particle6_2
execute if score Global dra_scratch1 matches 1.. if score Global z <= Global dra_scratch0 run function blingedit:particles/particle6_2
