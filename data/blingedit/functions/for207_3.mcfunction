...
scoreboard players add Global wall_count 1
scoreboard players operation Global x += Global mai_scratch6
execute if score Global x <= Global mai_scratch5 run function blingedit:for207_3